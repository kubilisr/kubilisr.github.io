...
~~~
Basically what I forgot to do is to set correct programmer option in Arduino IDE. Setting correct programmer option and attempting to upload sketch to attiny once more and I am struck with [different issue](https://gist.github.com/kubilisr/1bc786399acb3712761387db26babc8d/c93a8e0b2d2702f0ab65840e15ac2a49b3e0fa68){:target="_blank"} this time  
~~~
         Using Port                    : usb
...
Rerefences:
[Flashing bootloaders on an ATMega328 with the internal clock enabled](http://gizmosmith.com/2015/06/18/flashing-bootloaders-on-an-atmega328-with-the-internal-clock-enabled/){:target="_blank"}
